...
<html lang="en">
	...
	<body>
		...
		<div class="sticky">	
			<nav class="stroke" id="mainNav">
				<ul>
					...
					<li><a href="shop.php">Shop</a></li> <!-- Shop.php file -->
		...
		<div class="header">	
			<a name="Home">
				<img src="assets/Logo.jpeg" alt="Luca Loaves Logo">  
			</a>
		</div>
				...
				?>
					<tr>
						...
						<td style="text-align:center;">
							<a href="shop.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" />
						</td>
					</tr>
				<?php
	...
	?>
		...
		<div class="footer">
			...
			<a name="Contact">
				<h2 style="text-transform: uppercase;">Contact Details</h2>
			</a>
			<h5>
			...
			<img src="assets/breads-sydney-bourke-street-bakery.jpeg" alt="Breads" style="padding-bottom: 100px">
